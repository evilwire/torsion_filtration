...
filtration and cofiltration on $\HI$, then the following are true:
\begin{enumerate}
\item $\tlHI{n}\HI \tHI \tlHI{m}\HI \subseteq \tlHI{n + m}\HI$.

\item $\tgHI{n}\HI \tHI \tlHI{m}\HI \subseteq \tgHI{n + m}\HI$.
\end{enumerate}
\end{prop}
