...
$\HM$. Indeed, if $F_{k} \simeq \LHI{F_{k - 1}}$, then 
\[
\tlHM{n}(F_*)_k \defeq \tlHI{n + k}(F_{k}) \simeq 
   \LHI{\tlHI{n + k - 1}(F_{k - 1})}
   \defeq \LHI{\tlHM{n}(F_*)_{k - 1}}.
\]
Furthermore, if $F_{k - 1} \simeq \RHI{(F_{k})}$, then
\[
