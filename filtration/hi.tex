...
Consider the counit map $\cuHI_F: \LHI[n]{\RHI[n]{F}} \to F$, and 
write $\tgHI{n} F$ for the cokernel of $\cuHI_F$. We want to show 
that the functors $F \mapsto \LHI[n]{\RHI[n]{F}}$ defines a weak 
filtration of and $\tgHI{n}$ defines a strong cofiltration of 
$\HI$.
