...
The goal is to construct a torsion theory ($\TCat{n}$,$TFCat{n}$) 
for each $n > 0$, and that the torsion subcategories fits into 
tower of inclusion of full subcategories:
\[
\cdots \to \TCat{i} \to \TCat{i-1} \to \TCat{i-2} \to \cdots \to 
   \TCat{0} = \HI,
\]
and the $\into$

In this case, the reflection functor will be given by the 
associated radical. 
