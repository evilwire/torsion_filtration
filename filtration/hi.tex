...
\end{lem}
\begin{proof}
First, the cohomological functor $\rhomDMf(\Z(1)[1], -)$ is left 
$t$-exact (being the right adjoint of $-\tDM \Z(1)[1]$. By the 
preceding lemma and Prop \ref{prop_contract_is_exact},
$\rhomDMf(\Z(1)[1], -)$ is also exact on the heart of $\DMeff$,
whence it is $t$-exact.

That is, $\rhomDMf(\Z(1)[1], -)$ commutes with $\sheaf{H}^0$,
...
\begin{prop}\label{prop_H_commute_with_slice}
...
In spite of the result in Prop. \ref{prop_H_commute_with_slice}, 
