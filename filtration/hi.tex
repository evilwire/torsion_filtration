...
of adjoint functors obtained from the closed monoidal structure of
$\HI$. Recall that this structure is first defined in Section 
\ref{subsect_cls_monoid_struct_hi}.
...
We are justified writing $\RHI{F}$ for $\ihomHI{\Ox, F)$ 
