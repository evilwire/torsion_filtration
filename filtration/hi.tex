...
and write $\slHI{n} F$ for the cokernel of $\cuHI_F$. We want to 
show that the functors $F \mapsto \LHI[n]{\RHI[n]{F}}$ 
defines a weak filtration of and $\slHI{n}$ defines a
strong cofiltration of $\HI$.

To see this, let $\LHI[n]{\HI}$ denote the full subcategory of
$F \in \HI$ where $F = \LHI[n]{F'}$ for some $F' \in \HI$. It
is clear that if $m \geq n$, then $\LHI[m]{\HI} \subseteq 
\LHI[n]{\HI}$.
