...
\pfitem{(2)} : Suppose $F$ is in $\HI$. Since $\TFHI{n}$ is a
...
\pfitem{(3)} : Let $F$ be an object in $\HI(n)$. Then $F = 
...
Recall the definition of the structure constants of $(\GFiltDM{\DMeff}, 
