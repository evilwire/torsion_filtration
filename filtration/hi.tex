...
\begin{defn}
We say that a filtration $(\Cat{C}, f_*)$ is a \DEF{strong 
filtration} if for each $A \in \Cat{C}$ and $n \in \Z$, $f_n A$ is 
a subobject of $A$. Similarly a cofiltration $(\Cat{C}, c_*)$ is a 
\DEF{strong cofiltration} if $c_n A$ is a quotient of $A$ for each 
$n$.
\end{defn}
...
adjoint to the inclusion $\tlHI{n} \to \HI$.
