...
\begin{rmk}
The defintion we provided was for an $\N$-indexed filtration.
We can similarly define a $\Z$-index filtration in the obvious way.
An $\N$-indexed filtration is a $\Z$-index filtration for which
$\phi_i \Cat{C} = \phi_0 \Cat{C}$ for all negative values of $i$.
\end{rmk}
