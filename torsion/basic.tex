...
diagram). This map must be an injection, since its composition with
$h$ is the identity, and it must also be a surjection, since 
composing with $K \to K'$ equals the surjection $K \to \phi(K)$.
...
$\Cat{F}$-envelop (see \cite{Swan}).}, then the torsion 
