...
Dually, every idempotent pre-radical $\kappa$ is in one-to-one 
...
In the case that $\kappa$ is the idempotent pre-radical associated 
to the idempotent pre-coradical $\phi$ (see Prop. 
\ref{prop_rad_eq_corad}), then the two torsion theories agree. In
this case, $\phi$ is left adjoint to the inclusion $\Cat{F} \to 
