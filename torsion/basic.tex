...
\end{prop}
\begin{proof}
Fix $A \in \Cat{A}$, and let $\eta_A: A \to \phi A$ be the natural
surjection associated to $\phi$ as a quotient functor. Let $K$ be
the kernel of $A \to \phi(A)$, and consider the sequence
\[
